...
import 'carousel_controller.dart' as custom_carousel_controller;
import 'dart:async';

import 'package:flutter/gestures.dart';
import 'package:flutter/material.dart';
import 'package:project_two_blogclub/UI/carousel/carousel_state.dart';
...
class CarouselSlider extends StatefulWidget {
  ...
  final custom_carousel_controller.CarouselControllerImpl
      _carouselController; // تغییر این خط
  ...
  CarouselSlider(
      ...
      this.disableGesture,
      custom_carousel_controller.CarouselController?
          carouselController, // تغییر این خط
      Key? key})
      : itemBuilder = null,
        itemCount = items != null ? items.length : 0,
        _carouselController = carouselController != null
            ? carouselController
                as custom_carousel_controller.CarouselControllerImpl
            : custom_carousel_controller.CarouselController()
                as custom_carousel_controller.CarouselControllerImpl,
        super(key: key);
